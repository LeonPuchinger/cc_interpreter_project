...
typedef enum {
    ND_FUNC_DEFS, ND_FUNC_DEF, ND_STMTS, ND_INT, ND_STR, ND_ASSIGN, ND_PARAMS, ND_TYPE, ND_COND, ND_COND_ALT, ND_LOOP, ND_RET, ND_BOOL_EXPR, ND_STR_EXPR, ND_INT_EXPR, ND_FUNC_CALL, ND_EXPRS,
} AST_Node_Type;
